...
{
	echo "<br><h2><div  class=head1>You are not Logged In! Please Login first to Access this Page</div></h2>";
...
<form name="form1" method="post" onSubmit="return check();">
  <table width="80%"  border="0" align="center" bgcolor="white">
    <tr>
      <td width="24%" height="32"><div align="left"><strong>Select Exam Name </strong></div></td>
      <td width="1%" height="5">  
